...
const Home = ({ history, createNewGame }) => {
  const [friendlySpeed, setFriendlySpeed] = useState(
    (window.localStorage && window.localStorage.friendlySpeed) || "standard"
  );
  ...
  const changeFriendlySpeed = (speed) => {
    // amplitude.getInstance().logEvent('Change Friendly Speed', { speed });
    setFriendlySpeed(speed);

    if (window.localStorage) {
      window.localStorage.friendlySpeed = speed;
    }
  };
    ...
    <div className="home">
          ...
          <div className="home-banner-video">
            <form action="/guest/login" className="guest-button">
              <input
                type="hidden"
                name="_token"
                value="uLJkW-jK76xU0k1RN2_cS3Y0Ncaf8hcV76ateY571-g"
              />
              <button type="submit">
              ...
              <div className="guest-button-form">
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="guest-on-subtitle">
      ...
      <section className="suggestion">
        <div className="suggestion-comment-section">
          <div>
            <h2 className="suggestion-title">Solve Chess Puzzles</h2>
      ...
      <section className="suggestion">
        ...
        <div className="suggestion-comment-section">
          <div>
            <h2 className="suggestion-title">Take Chess Lessons</h2>
            <div style={{ display: "flex" }}>
      ...
      <section className="posts-component">
        ...
        <div className="posts-wrapper">
          <a
            href="https://www.chess.com/article/view/2021-womens-speed-chess-championship-all-the-information"
            className="post"
          >
            <div className="post-img">
              <img
                alt="2021 women learn"
                src={womenlearn}
                className="post-img-thumbnail"
              />
            </div>
            <h3 className="post-name">
              2021 Women's Speed Chess Championship: Bibisara Assaubayeva Wins
              Qualifier 3
            </h3>
            <div className="post-author">CHESScom</div>
          </a>
          <a
            href="https://www.chess.com/news/view/ftx-crypto-cup-carlsen-so-in-final"
            className="post"
          >
            <div className="post-img">
              <img
          ...
          <a
            href="https://www.chess.com/article/view/the-intersection-of-poker-and-chess"
            className="post"
          >
            <div className="post-img">
              <img
          ...
          <a
            href="https://www.chess.com/video/player/how-to-play-the-kings-indian-attack-beating-h7-h6"
            className="post"
          >
            <div className="post-img">
            ...
            <h3 className="post-name">
              How To Play The King's Indian Attack: Beating h7-h6
            </h3>
            <div className="post-author">
              <span className="index-chess-title">GM</span>dbojkov
            </div>
          </a>
        </div>
      </section>
      <div className="home-play-buttons">
        <div className="home-play-button-wrapper">
          <Link to="/campaign">
            <div className="home-play-button">Campaign</div>
          </Link>
        ...
        <div className="home-play-button-wrapper">
          <div
            ...
            onClick={() => createNewGame(friendlySpeed, true, "novice")}
          >
            Play vs AI
          </div>
          <div className="home-play-option-wrapper">
            <div
              className={`home-play-option ${
                friendlySpeed === "standard" ? "selected" : ""
              }`}
              onClick={() => changeFriendlySpeed("standard")}
            >
              Standard
            </div>
            <div
              className={`home-play-option ${
                friendlySpeed === "lightning" ? "selected" : ""
              }`}
              onClick={() => changeFriendlySpeed("lightning")}
            >
              Lightning
            </div>
          </div>
        ...
        <div className="home-play-button-wrapper">
          <div
            className="home-play-button"
            onClick={() => createNewGame(friendlySpeed, false)}
          >
            Play vs Friend
          </div>
          <div className="home-play-option-wrapper">
...
//     this.state = {
//       friendlySpeed:
//         (window.localStorage && window.localStorage.friendlySpeed) ||
//         "standard",
//       show: false,
//     };
//   }
...
//                     content={<SelectLevel handleOpen={this.handleShow} />}
//                   />
//                 </div>
//                 <a href="/play/computer" className="guest-button guest-link">
//                   <div className="playhand-icon computer-icon" />
...
//               </div>
//               <h3 className="post-name">
//                 FTX Crypto Cup: Carlsen, So In Final
//               </h3>
//               <div className="post-author">PeterDoggers</div>
//             </a>
//             <a
...
//               className="home-play-button"
//               onClick={() =>
//                 this.props.createNewGame(friendlySpeed, true, "novice")
//               }
//             >
//               Play vs AI
//             </div>
